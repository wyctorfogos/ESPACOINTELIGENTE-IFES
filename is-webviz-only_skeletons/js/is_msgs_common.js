(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.is_msgs_common = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
/**
 * @fileoverview
 * @enhanceable
...
goog.exportSymbol('proto.is.common.ConsumerInfo', null, global);
goog.exportSymbol('proto.is.common.ConsumerList', null, global);
 ...
 * @constructor
 */
proto.is.common.ConsumerInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.is.common.ConsumerInfo.repeatedFields_, null);
};
goog.inherits(proto.is.common.ConsumerInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.is.common.ConsumerInfo.displayName = 'proto.is.common.ConsumerInfo';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.is.common.ConsumerInfo.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.is.common.ConsumerInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.is.common.ConsumerInfo.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.is.common.ConsumerInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.is.common.ConsumerInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    consumersList: jspb.Message.getRepeatedField(msg, 2)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.is.common.ConsumerInfo}
 */
proto.is.common.ConsumerInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.is.common.ConsumerInfo;
  return proto.is.common.ConsumerInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.is.common.ConsumerInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.is.common.ConsumerInfo}
 */
proto.is.common.ConsumerInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.is.common.ConsumerInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.is.common.ConsumerInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.is.common.ConsumerInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.is.common.ConsumerInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array.<string>}
 */
proto.is.common.ConsumerInfo.prototype.getConsumersList = function() {
  return /** @type {!Array.<string>} */ (jspb.Message.getRepeatedField(this, 2));
};


/** @param {!Array.<string>} value */
proto.is.common.ConsumerInfo.prototype.setConsumersList = function(value) {
  jspb.Message.setField(this, 2, value || []);
};
 ...
 * @param {number=} opt_index
 */
proto.is.common.ConsumerInfo.prototype.addConsumers = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 2, value, opt_index);
};


proto.is.common.ConsumerInfo.prototype.clearConsumersList = function() {
 ...
 * @constructor
 */
proto.is.common.ConsumerList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.is.common.ConsumerList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.is.common.ConsumerList.displayName = 'proto.is.common.ConsumerList';
}
 ...
 * @return {!Object}
 */
proto.is.common.ConsumerList.prototype.toObject = function(opt_includeInstance) {
  return proto.is.common.ConsumerList.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.is.common.ConsumerList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.is.common.ConsumerList.toObject = function(includeInstance, msg) {
  var f, obj = {
    infoMap: (f = msg.getInfoMap()) ? f.toObject(includeInstance, proto.is.common.ConsumerInfo.toObject) : []
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.is.common.ConsumerList}
 */
proto.is.common.ConsumerList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.is.common.ConsumerList;
  return proto.is.common.ConsumerList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.is.common.ConsumerList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.is.common.ConsumerList}
 */
proto.is.common.ConsumerList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.is.common.ConsumerInfo.deserializeBinaryFromReader);
         });
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.is.common.ConsumerList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.is.common.ConsumerList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.is.common.ConsumerList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.is.common.ConsumerList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getInfoMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(1, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.is.common.ConsumerInfo.serializeBinaryToWriter);
  }
};
 ...
 * @return {!jspb.Map<string,!proto.is.common.ConsumerInfo>}
 */
proto.is.common.ConsumerList.prototype.getInfoMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.is.common.ConsumerInfo>} */ (
      jspb.Message.getMapField(this, 1, opt_noLazyCreate,
      proto.is.common.ConsumerInfo));
};


proto.is.common.ConsumerList.prototype.clearInfoMap = function() {
...
},{"google-protobuf":4,"google-protobuf/google/protobuf/wrappers_pb.js":5}],2:[function(require,module,exports){
'use strict'
